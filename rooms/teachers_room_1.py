...
def enterTeachersRoom1(state):
    ...
    def handle_look():
        ...
        print("The teacher's screen shows a Python function, almost finished.")
        if not state["visited"]["teachersroom1"]:
            print("The teacher looks up: \"Oh, perfect timing. I'm missing one last piece of this code.\"")
            print("\"If you can figure out what goes in the blank, I'll make it worth your while.\"")
            print("""
    ...
    return total
""")
            print("The teacher taps the blank on the screen: \"So — what goes here?\"")
        else:
    ...
    def handle_go(destination):
        if destination in ["corridor", "back"]:
            print("You wave goodbye to the teacher and step back into the corridor.")
            return "corridor"
        else:
